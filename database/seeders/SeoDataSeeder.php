    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'seo_description' => 'Стоматологическая клиника «ДАНТИСТиК» в Курск. Все виды стоматологических услуг',
                'page_title' => '',
                // 'seoable_id' => 1,
            ...
            [
                'url' => 'contacts',
                'seo_title' => 'Контакты стоматологической клиники',
            ...
            [
                'url' => 'services',
                'seo_title' => 'Стоматологические услуги в Курске от клиники «ДАНТИСТиК»',
