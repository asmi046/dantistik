    ...
    public function run(): void
    {
        ...
        $services = [
            [
                ...
                'short_title' => 'Лечение кариеса и его осложнений, лечение некариозных поражений, эстетические реставрации, повторное эндодонтическое лечение',
            ...
            [
                ...
                'short_title' => 'Удаление зубов, имплантация, костная пластика, пластика десны',
            ...
            [
                ...
                'short_title' => 'Подбор индивидуальных средств гигиены, профессиональное удаление зубных отложений, фторирование и реминерализация эмали',
            ...
            [
                ...
                'short_title' => 'Коронки, мостовидные протезы, съемные и несъемные конструкции, ортопедические конструкции на имплантатах',
